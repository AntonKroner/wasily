...
int to_lfs_open_flags(const __wasi_oflags_t flags, const __wasi_rights_t rights) {
  int result = 0;
...
#define REQUIRE_TYPED_FD(__fd, __type, __rights, __allow_stream)                    \
  (*({                                                                              \
    ...
    RETURN_IF_WASI_ERR(lookup_fd(__fd, __type, __rights, __allow_stream, &__desc)); \
    __desc;                                                                         \
  }))
...
struct Context {
    ...
    __wasi_errno_t lookup_fd(
      const __wasi_fd_t fd,
      const int type,
      const __wasi_rights_t rights,
      const bool allow_streams,
    ...
    __wasi_errno_t fd_fdstat_set_rights(
      ...
      const auto new_rights_inheriting = desc.rights_inheriting & fs_rights_inheriting;
    ...
    __wasi_errno_t fd_pread(
      ...
      RETURN_IF_LFS_ERR(lfs_file_seek(&lfs, &desc.file(), previous_offset, LFS_SEEK_SET));
      RETURN_IF_LFS_ERR(lfs_file_sync(&lfs, &desc.file()));
      *retptr0 = read;
      return __WASI_ERRNO_SUCCESS;
    }
    __wasi_errno_t fd_prestat_dir_name(__wasi_fd_t fd, const std::span<char>& result) {
    ...
    __wasi_errno_t fd_seek(
      ...
      switch (whence) {
        case __WASI_WHENCE_SET:
          *retptr0 = RETURN_IF_LFS_ERR(lfs_file_seek(&lfs, &file, offset, LFS_SEEK_SET));
          break;
        case __WASI_WHENCE_CUR:
          *retptr0 = RETURN_IF_LFS_ERR(lfs_file_seek(&lfs, &file, offset, LFS_SEEK_CUR));
          break;
        case __WASI_WHENCE_END:
          *retptr0 = RETURN_IF_LFS_ERR(lfs_file_seek(&lfs, &file, offset, LFS_SEEK_END));
          break;
        default:
          return __WASI_ERRNO_INVAL;
      }
    ...
    __wasi_errno_t fd_write(
      ...
      for (size_t i = 0; i < iovs_len; ++i) {
        written +=
          RETURN_IF_LFS_ERR(lfs_file_write(&lfs, &file, iovs[i].buf, iovs[i].buf_len));
      }
      if (append) {
        // reset file position
        file.flags &= ~LFS_O_APPEND;
        RETURN_IF_LFS_ERR(lfs_file_seek(&lfs, &file, previous_offset, LFS_SEEK_SET));
      }
      RETURN_IF_LFS_ERR(lfs_file_sync(&lfs, &file));
      *retptr0 = written;
      return __WASI_ERRNO_SUCCESS;
    ...
    __wasi_errno_t path_filestat_get(
      ...
      const char* path;
      RETURN_IF_WASI_ERR(
        resolve_path(frame, fd, unresolved_path, __WASI_RIGHTS_PATH_FILESTAT_GET, &path));
    ...
    __wasi_errno_t path_open(
      ...
      const auto& dir = REQUIRE_TYPED_FD(fd, LFS_TYPE_DIR, required_rights, false);
      const char* path;
      ...
      if (oflags & __WASI_OFLAGS_DIRECTORY) {
        ...
        RETURN_IF_LFS_ERR(lfs_file_open(
          &lfs,
          &desc->file(),
          path,
    ...
    __wasi_errno_t path_unlink_file(
      ...
      const char* path;
      RETURN_IF_WASI_ERR(
        resolve_path(frame, fd, unresolved_path, __WASI_RIGHTS_PATH_UNLINK_FILE, &path));
      lfs_info info{};
      const auto rc = lfs_stat(&lfs, path, &info);
      if (rc == LFS_ERR_OK && info.type == LFS_TYPE_DIR) {
        return __WASI_ERRNO_ISDIR;
  ...
  private:
    __wasi_errno_t set_file_times(
      const char* path,
      const __wasi_timestamp_t atim,
      const __wasi_timestamp_t mtim,
      const __wasi_fstflags_t fst_flags) {
      auto m = get_metadata(path);
      if ((fst_flags & __WASI_FSTFLAGS_ATIM) && (fst_flags & __WASI_FSTFLAGS_ATIM_NOW)) {
        return __WASI_ERRNO_INVAL;
      }
      if ((fst_flags & __WASI_FSTFLAGS_MTIM) && (fst_flags & __WASI_FSTFLAGS_MTIM_NOW)) {
        return __WASI_ERRNO_INVAL;
      }
...
template<class T> auto with_external_ciovs(
  CallFrame& frame,
  int32_t iovs_ptr,
  int32_t iovs_len,
  T&& callback) {
...
template<class T>
auto with_external_iovs(CallFrame& frame, int32_t iovs_ptr, int32_t iovs_len, T&& callback) {
  ...
  for (auto& iov: iovs) {
    rw_buffers.emplace_back(frame, reinterpret_cast<int32_t>(iov.buf), iov.buf_len);
    iov.buf = rw_buffers.back().value.data();
  }
  return callback(iovs.data());
}
#define EXPORT(x) __attribute__((__export_name__(#x))) x
int32_t EXPORT(fd_advise)(int32_t arg0, int64_t arg1, int64_t arg2, int32_t arg3) {
...
int32_t EXPORT(fd_close)(int32_t arg0) {
  return state.fd_close(arg0);
}
int32_t EXPORT(fd_datasync)(int32_t arg0) {
  return state.fd_datasync(arg0);
}
...
int32_t EXPORT(
  fd_filestat_set_times)(int32_t arg0, int64_t arg1, int64_t arg2, int32_t arg3) {
  return state.fd_filestat_set_times(arg0, arg1, arg2, arg3);
}
int32_t EXPORT(
  fd_pread)(int32_t arg0, int32_t arg1, int32_t arg2, int64_t arg3, int32_t arg4) {
  CallFrame frame;
...
int32_t EXPORT(
  fd_pwrite)(int32_t arg0, int32_t arg1, int32_t arg2, int64_t arg3, int32_t arg4) {
  CallFrame frame;
  MutableView<__wasi_size_t> out(frame, arg4);
...
int32_t EXPORT(fd_read)(int32_t arg0, int32_t arg1, int32_t arg2, int32_t arg3) {
  CallFrame frame;
...
int32_t EXPORT(
  fd_readdir)(int32_t arg0, int32_t arg1, int32_t arg2, int64_t arg3, int32_t arg4) {
  CallFrame frame;
...
int32_t EXPORT(fd_seek)(int32_t arg0, int64_t arg1, int32_t arg2, int32_t arg3) {
  CallFrame frame;
  MutableView<__wasi_filesize_t> out(frame, arg3);
  return state.fd_seek(arg0, arg1, arg2, &out.get());
}
int32_t EXPORT(fd_sync)(int32_t arg0) {
  return state.fd_sync(arg0);
}
...
int32_t EXPORT(fd_write)(int32_t arg0, int32_t arg1, int32_t arg2, int32_t arg3) {
  CallFrame frame;
  MutableView<__wasi_size_t> out(frame, arg3);
  return with_external_ciovs(frame, arg1, arg2, [&](__wasi_ciovec_t* iovs) {
...
int32_t EXPORT(path_create_directory)(int32_t arg0, int32_t arg1, int32_t arg2) {
  CallFrame frame;
  return state.path_create_directory(frame, arg0, frame.ref_string(arg1, arg2));
}
int32_t EXPORT(
  path_filestat_get)(int32_t arg0, int32_t arg1, int32_t arg2, int32_t arg3, int32_t arg4) {
  CallFrame frame;
  MutableView<__wasi_filestat_t> out(frame, arg4);
  return state
    .path_filestat_get(frame, arg0, arg1, frame.ref_string(arg2, arg3), &out.get());
}
int32_t EXPORT(path_filestat_set_times)(
  int32_t arg0,
  int32_t arg1,
  int32_t arg2,
  int32_t arg3,
  ...
  return state.path_filestat_set_times(
    ...
    arg0,
    arg1,
    frame.ref_string(arg2, arg3),
    arg4,
    arg5,
    arg6);
}
int32_t EXPORT(path_link)(
  int32_t arg0,
  int32_t arg1,
  int32_t arg2,
  int32_t arg3,
...
int32_t EXPORT(path_readlink)(
  ...
  return state.path_readlink(arg0, frame.ref_string(arg1, arg2), out1.value, &out2.get());
}
int32_t EXPORT(path_remove_directory)(int32_t arg0, int32_t arg1, int32_t arg2) {
  CallFrame frame;
  return state.path_remove_directory(frame, arg0, frame.ref_string(arg1, arg2));
}
int32_t EXPORT(path_rename)(
  int32_t arg0,
  int32_t arg1,
  int32_t arg2,
  int32_t arg3,
  ...
  int32_t arg5) {
  CallFrame frame;
  return state.path_rename(
    frame,
    arg0,
    frame.ref_string(arg1, arg2),
    arg3,
    frame.ref_string(arg4, arg5));
}
int32_t EXPORT(
  path_symlink)(int32_t arg0, int32_t arg1, int32_t arg2, int32_t arg3, int32_t arg4) {
  CallFrame frame;
  return state
    .path_symlink(frame.ref_string(arg0, arg1), arg2, frame.ref_string(arg3, arg4));
}
...
int32_t EXPORT(initialize_internal)(int32_t arg0, int32_t arg1) {
  ...
  for (const auto& m: d["fs"].GetObject()) {
    ...
    lfs_file_t file;
    LFS_REQUIRE(
      lfs_file_open(&state.lfs, &file, path, LFS_O_WRONLY | LFS_O_CREAT | LFS_O_EXCL));
    LFS_REQUIRE(
      lfs_file_write(&state.lfs, &file, m.value.GetString(), m.value.GetStringLength()));
